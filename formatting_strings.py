...
tasks_total = round((team1_time + team2_time) / (score_1 + score_2), 1)

print(f'Сегодня было решено {score_1 + score_2} задачи, в среднем по {tasks_total} секунды на задачу!')
